...
export const ERRORS = {
    ...
    meetingExists: new AppError('Meeting already exists', 409),
    meetingNotExists: new AppError('Meeting not exists', 404),
    meetingCredError: new AppError('You are not the owner of this meeting', 401),
    meetingsNotFound: new AppError('No meetings found for this user', 404),
    meetingsOverlapping: new AppError('Meeting overlap to existing meeting', 400)
};
