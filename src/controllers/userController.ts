...
import { IUserLoginDto, IUserSignupDto } from "../models/user";
import { prisma, utils } from "../utils/utils";


export const login = async (request: FastifyRequest<{Body: IUserLoginDto}>, reply: FastifyReply) => {
    try {
...
export const signUp = async (request: FastifyRequest<{Body: IUserSignupDto;}>,reply: FastifyReply,) => {
    try {
